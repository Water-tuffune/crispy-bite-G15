...
(1, 1, 'Classic Crispy Chicken Meal', 'Two crispy chicken pieces with fries and a drink.', 9.99, 'https://placehold.co/600x400/cc1f1a/ffffff?text=Classic+Chicken', 'available', 18),
(2, 1, 'Spicy Crunch Chicken Meal', 'Spicy chicken pieces served with fries.', 10.99, 'https://placehold.co/600x400/111111/ffffff?text=Spicy+Crunch', 'available', 20),
(3, 1, 'Herb Roast Chicken Plate', 'Juicy roast-style chicken with herbs and slaw.', 11.49, 'https://placehold.co/600x400/e8b923/111111?text=Herb+Chicken', 'available', 22),
(4, 2, 'Crispy Bite Burger', 'Crispy chicken fillet, lettuce, tomato, and house sauce.', 7.99, 'https://placehold.co/600x400/cc1f1a/ffffff?text=Crispy+Burger', 'available', 14),
(5, 2, 'Double Stack Burger', 'Two chicken fillets with cheese and pickles.', 10.49, 'https://placehold.co/600x400/111111/ffffff?text=Double+Stack', 'available', 16),
(6, 2, 'Mini Crunch Slider', 'Small crispy slider for a quick snack.', 4.50, 'https://placehold.co/600x400/f7f7f7/111111?text=Slider', 'available', 10),
(7, 3, 'Spicy Chicken Wrap', 'Chicken strips wrapped with salad and spicy sauce.', 6.99, 'https://placehold.co/600x400/cc1f1a/ffffff?text=Spicy+Wrap', 'available', 12),
(8, 3, 'Garden Crunch Wrap', 'Crunchy chicken, vegetables, and creamy dressing.', 6.49, 'https://placehold.co/600x400/e8b923/111111?text=Garden+Wrap', 'available', 12),
(9, 4, 'Fresh Lemonade', 'Chilled lemonade with a bright citrus taste.', 2.50, 'https://placehold.co/600x400/f7f7f7/111111?text=Lemonade', 'available', 3),
(10, 4, 'Berry Cooler', 'Sweet berry drink served cold.', 2.99, 'https://placehold.co/600x400/cc1f1a/ffffff?text=Berry+Cooler', 'available', 3),
(11, 5, 'Golden Fries', 'Crisp fries with light seasoning.', 3.25, 'https://placehold.co/600x400/e8b923/111111?text=Fries', 'available', 8),
(12, 5, 'Creamy Coleslaw', 'Fresh cabbage slaw with creamy dressing.', 2.75, 'https://placehold.co/600x400/f7f7f7/111111?text=Coleslaw', 'available', 4),
(13, 5, 'Crispy Nuggets', 'Six crunchy chicken nuggets with dipping sauce.', 5.49, 'https://placehold.co/600x400/111111/ffffff?text=Nuggets', 'available', 10),
(14, 6, 'Family Feast Bucket', 'Eight chicken pieces, four fries, and four drinks.', 27.99, 'https://placehold.co/600x400/cc1f1a/ffffff?text=Family+Feast', 'available', 28),
(15, 6, 'Party Crunch Bucket', 'Twelve chicken pieces with sides for sharing.', 38.99, 'https://placehold.co/600x400/111111/ffffff?text=Party+Bucket', 'unavailable', 35);
